# Chinese UI Translation Checklist

This checklist was generated from a repository-wide scan for Chinese characters. Items are grouped by area and represent files that still contain Chinese text to review/translate. HTML pages are completed in this pass; remaining files are unchecked for follow-up.

## Public HTML pages
- [x] public/login.html
- [x] public/register.html
- [x] public/welcome.html
- [x] public/forum.html
- [x] public/public-characters.html

## Public scripts
- [x] public/scripts/login.js.bak
- [x] public/scripts/login.js
- [x] public/scripts/register.js
- [x] public/scripts/forum.js
- [x] public/scripts/public-characters.js
- [x] public/scripts/public-pages-config.js
- [x] public/scripts/user.js
